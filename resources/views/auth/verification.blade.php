...
<div class="noo-page-heading">
	<div class="container-boxed max text-center parallax-content">
		...
		<div class="page-sub-heading-info">
			verify email id to access your account
		</div>
	</div>
</div> 
	...
	<div class="row">
		<div class="login-box">
	      <div class="login-box-body">
	        <p class="login-box-msg">Resend varification mail</p>
	        <form id="loginform" role="form" method="POST" action="{{ url('auth/verification') }}" method="post">
	          <input type="hidden" name="_token" value="{{ csrf_token() }}">
	          <div class="form-group has-feedback">
	            <input type="email" class="form-control" name="email" placeholder="Email" value="{{ old('username') }}" required>
